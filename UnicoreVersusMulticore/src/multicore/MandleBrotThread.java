...
public class MandleBrotThread implements Runnable {
	...
	final static int MAX_ITERATIONS = 100000, SCREEN_HEIGHT = 1080, SCREEN_WIDTH = 1920;
	...
	public MandleBrotThread(String threadName, int beginX, int beginY, int endX, int endY,long startTime) {
...
//					System.out.println("Called iterations>=max");
		...
		try {
			...
			System.out.println("Thread: "+threadName+" Finished Executing in: "+(System.currentTimeMillis()-startTime)+"ms");
		} catch (Exception e) {
			e.printStackTrace();
